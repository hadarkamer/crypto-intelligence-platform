...
async def check():
    ...
    with patch.object(main, "research_watch_scan_intake", SimpleNamespace(WORKER=watch_intake)), \
        ...
        assert calls == [("watch-intake", "start"), ("watch-measurement", "start"), ("watch-formulas", "start"), ("watch-timeframes", "start"), ("btc", "start"), ("formula", "start"), ("experimental", "start"), ("snapshot", "start")]
        ...
        assert calls[-8:] == [("watch-intake", "stop"), ("watch-measurement", "stop"), ("watch-formulas", "stop"), ("watch-timeframes", "stop"), ("experimental", "stop"), ("snapshot", "stop"), ("formula", "stop"), ("btc", "stop")]
