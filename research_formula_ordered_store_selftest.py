...
def run():
    ...
    scope={'scope_key':'scope','candidate_key':'STRICT_TRIPLE_TOTAL_65','symbol':'ALL','direction':'LONG','window_minutes':60,'threshold_bps':25,'result':{}}
    ...
    print('ordered Formula store: FRESH denominator, stable generation, incomplete cohort gates PASS')
